...
<html>
	...
	<body>
		...
		<h3><?php echo $_GET['parcelle'];?></h3>
		<form style="margin:auto;text-align:center;" class="form-inline" role="form" method="POST" action="./function/user_addexperience.php?parcelle=<?php echo $_GET['parcelle']?>">
  		<div class="form-group">
    		<label for="name">Nouvelle Experience :</label>
